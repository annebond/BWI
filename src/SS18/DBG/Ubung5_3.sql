...
EXCEPTION
  -- Exception Handling, falls selects in when cases no data liefern würde, soll -1 zurückkommen
  WHEN NO_DATA_FOUND THEN
    v_flugID_next := -1;
...
Achten Sie dabei auf Folgendes: Explizites Exception Handling (mit Hilfe der Klausel exception) ist vorerst noch nicht vorgesehen. Versuchen Sie trotzdem mögliche Fehler abzufangen. Im Fehlerfall geben Sie -1 zurück
