...
EXCEPTION
    ...
    WHEN speziellerFlug THEN
      RAISE_APPLICATION_ERROR(-20001, 'Dieser Flug darf nicht gecancelt werden. Alle Änderungen werden zurückgesetzt. FlugID: ' || v_flugID);
      rollback to savepoint startDelFlug;
    WHEN OTHERS THEN
...
-- Ubung 6/4 --
/*
Prüfen Sie anhand Aufgabe 4 aus Übung 5 (ganzer Flug wird gecancelt), ob obiger Trigger aus Beispiel 3 tatsächlich funktioniert. 
Überlegen Sie sich eine Situation, wo am Ende der Umbuchung ein Rollback durchgeführt wird (Prozedur entsprechend anpassen). Überprüfen Sie, ob das Logging trotzdem stattfindet! 
*/
